...
var SharedUserNode *UserNode = nil
...
// AddSubPID 添加子PID
func (this *UserNode) AddSubPID(pid int) {
...
// 添加端口到防火墙
func (this *UserNode) addPortsToFirewall() {
...
// 启动API节点
func (this *UserNode) startAPINode() {
